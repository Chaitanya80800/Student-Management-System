...
<div class="pt-2">
<a href="#enroll">
<button class="btn btn-outline-primary">Enroll Student</button></a>
<a href="#view">
<button class="btn btn-outline-primary">View Student</button></a>
<a href="/">
...
<div class="col-md-6 d-flex align-items-center">
	...
	<input type="number" id="birthdayDate" class="form-control form-control-sm" name="studentAge" />
...
<div class="col-md-6 mb-2 pb-2">
		<div class="form-outline">
		<input type="text" id="collegeName" class="form-control form-control-sm" name="studentCollegeName">
		<label class="form-label" for="collegeName">Student College Name</label>
		</div>
</div>
</div>
...
<div class="row">
	<div class="col-md-6 mb-2 pb-2">
		<div class="form-outline">
		<input type="number" id="fees" class="form-control form-control-sm" name="feesPaid">
		<label class="form-label" for="fees">Fees Paid</label>
		</div>
	</div>
	...
	<h6 class="mb-2 pb-1">Student Course</h6>
		...
		<input type="radio" id="java" class="form-check-input" name="studentCourse"  value="Java">
		<label class="form-check-label" for="java">Java</label>
		</div>
	
	<div class="form-check form-check-inline">
		<input type="radio" id="python" class="form-check-input" name="studentCourse"  value="Python">
		<label class="form-check-label" for="python">Python</label>
		</div>
		
		<div class="form-check form-check-inline">
		<input type="radio" id="testing" class="form-check-input" name="studentCourse"  value="Testing">
...
<div class="row">
	<div class="col">
		...
		<option value="#" disabled="disabled">Select Batch Mode</option>
...
<div class="mt-2 pt-2 d-flex justify-content-center">
	...
	<form action="search" class="w-100">
		<select class="select form-control-sm border border-primary" name="batchNumber">
			<option value="#" selected="selected">Select Batch Number</option>
			<option value="FDJ-160">FDJ-160</option>
			<option value="REG-160">REG-160</option>
			<option value="FDJ-161">FDJ-161</option>
			<option value="REG-161">REG-161</option>
...
<marquee>
	...
	<table class="table table-hover" style="font-size:small">
		...
		<tr>
			...
			<td>
			<div class="btn-group btn-group-sm" role="group" arial-label="...">
